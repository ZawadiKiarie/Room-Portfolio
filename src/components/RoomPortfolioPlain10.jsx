...
export function PlainModel(props) {
  const { nodes, materials } = useGLTF("/models/RoomPortfolioPlain10-v1.glb");
  const group = useRef();
  ...
  return (
    ...
    >
      ...
      />
      <group name="Bulb6_hover" position={[3.195, 7.256, 0.3]}>
        <mesh
          name="Cube013"
      ...
      <group name="Bulb5_hover" position={[3.153, 7.039, -0.038]}>
        <mesh
          name="Cube015"
      ...
      <group name="Bulb4_hover" position={[3.124, 6.856, -0.401]}>
        <mesh
          name="Cube017"
      ...
      <group name="Bulb3_hover" position={[3.103, 6.741, -0.795]}>
        <mesh
          name="Cube022"
      ...
      <group name="Bulb2_hover" position={[3.089, 6.734, -1.227]}>
        <mesh
          name="Cube025"
      ...
      <group name="Bulb1_hover" position={[3.091, 6.836, -1.627]}>
        <mesh
          name="Cube027"
      ...
      <group name="Bulb11_hover" position={[2.298, 6.944, 2.901]}>
        <mesh
          name="Cube029"
      ...
      <group name="Bulb10_hover" position={[2.527, 6.953, 2.555]}>
        <mesh
          name="Cube031"
      ...
      <group name="Bulb9_hover" position={[2.788, 7.043, 2.251]}>
        <mesh
          name="Cube033"
      ...
      <group name="Bulb8_hover" position={[3.058, 7.202, 1.996]}>
        <mesh
          name="Cube035"
      ...
      <group name="bulb7_hover" position={[3.324, 7.412, 1.777]}>
        <mesh
          name="Cube037"
      ...
      <group name="Organizer_hover" position={[2.879, 4.556, -2.63]}>
        <mesh
          ...
          material={materials.Organizer}
        />
        <mesh
          name="Cube538_1"
          geometry={nodes.Cube538_1.geometry}
          material={materials.Pens}
        />
        <mesh
          name="Cube538_2"
      ...
      <group name="Carpet_hover" position={[-1.263, 2.068, -1.095]}>
        <mesh
          name="Cube052"
...
useGLTF.preload("/models/RoomPortfolioPlain10-v1.glb");
